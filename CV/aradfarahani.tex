...
\begin{document}
	...
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Worked as a proofreader to Edit Geology books for University Entrance Exams}
	\end{itemize}
	...
	\begin{description}[itemsep=0pt]
		...
		Seismic Data Processing, Applied Geophysics, Remote Sensing, Hydrogeophysics, Machine Learning, Image Processing, Open-Source Software Development, Inverse Problems
