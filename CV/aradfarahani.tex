...
\section{Address}
\begin{enumerate}[label=,left=0pt,topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
	\item Room 309, 3/F, Mong Man Wai Building, CUHK, New Territories, Hong Kong SAR
\end{enumerate}
