...
\begin{document}
	...
	\vspace{-0.78em} 
	\ressubheading{Kharazmi University}{Tehran, Iran}{Programming Teaching Assistant}{February 2025 – June 2025}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
	...
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Geostatistics Course, under supervision of Dr. Ehsan Pegah}	\ressubheading{Young Scholars Club}{Tehran, Iran}{Instructor}{July 2024}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
