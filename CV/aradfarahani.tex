	...
	\begin{justify}
	 ...
	 \subsection*{Conference Papers}
			...
			\begin{enumerate}[label=\arabic*.,left=0pt,topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
				...
				\item Rezaei, K., \textbf{Farmahini Farahani, M.}, Karimzadehasl, E. (Trans.). (2024). \textit{Introduction to Python in Earth science data analysis: From descriptive statistics to machine learning}. \textbf{Tasir Publication.}
		...
		\begin{itemize}[left=0pt, label={}, topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
			\item \textbf{LeetCode Global Ranking} - \textit{Ranked Top 100}, \href{https://leetcode.com/u/aradfarahani/}{\dotuline{LeetCode}} \hfill \textit{2025}
			\item \textbf{Deep-ML Global Leaderboard} - \textit{Ranked Top 50}, \href{https://www.deep-ml.com/leaderboard}{\dotuline{Deep-ML.com}} \hfill \textit{}
			\item \textbf{Master's Entrance Exam (Geophysics)} - \textit{Ranked 8\textsuperscript{th} Nationwide} \hfill \textit{}
