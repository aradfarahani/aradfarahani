...
\begin{itemize}[topsep=9pt, partopsep=0pt, itemsep=3.5pt, parsep=0pt]
	\resitem{Presented a numerical groundwater modeling study on water abstraction impacts in the Weyib Watershed, Ethiopia. Under Supervision of the Professor Arnaud Gauthier.}
\end{itemize}
	\vspace{-2em} 
	...
	\end{itemize}
	\vspace{-0.50em} 
	\ressubheading{Space Research and Technology Institute (SRTI)}{Primorsko, Bulgaria}{Lecturer}{August 2026 – September 2026}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{EPEC ML WG Summer School 2026, under supervision of Prof. Lachezar Filchev}
	\end{itemize}
	\vspace{-0.50em} 
