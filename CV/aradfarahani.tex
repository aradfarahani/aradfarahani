...
\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
	\resitem{Performed MASW analysis to extract dispersion images under Dr. Mehdi Talkhablou.}
\end{itemize}
	\vspace{-0.50em} 
