...
\begin{document}
	...
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Organized and instructed the \href{https://github.com/aradfarahani/KhUAdvanceGeoML}{Advanced Python and Machine Learning Workshop}}
	\end{itemize}
		\vspace{-0.50em} 
...
\footnotetext[3]{Civil Aviation Authority of Islamic Republic of Iran}
	...
	\begin{itemize}[left=0pt, label={}, topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		...
		\item \textbf{Deep-ML Global Leaderboard} - \textit{Ranked Top 50}, \href{https://www.deep-ml.com/leaderboard}{Deep-ML.com} \hfill \textit{}
