...
\fancyfoot[L]{\color{footergray}\footnotesize Room 309, 3/F, Mong Man Wai Building, EES, CUHK}
...
\end{itemize}
	...
	\vspace{-0.78em} 
	\ressubheading{CUHK}{Hong Kong SAR}{Hydrogeology Teaching Assistant}{August 2026 – Present}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{(EESC3320), under supervision of Prof. Yen Joe Tan}
	\end{itemize}
	\vspace{0.36em}

	
	\ressubheading{Space Research and Technology Institute (SRTI) - Bulgarian Space Agency)}{Primorsko, Bulgaria}{Lecturer}{August 2026 – September 2026}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{EPEC – Machine Learning WG Summer School 2026
In collaboration with Europlanet, under supervision of Prof. Lachezar Filchev}
	\end{itemize}
	\vspace{0.36em} 
	...
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Programming Course, under supervision of Prof. Morteza Asemani}
	\end{itemize}
	\vspace{-0.50em} 
	\ressubheading{Kharazmi University}{Tehran, Iran}{Geostatistics Teaching Assistant}{February 2025 – June 2025}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Geostatistics Course, under supervision of Prof. Ehsan Pegah}
	\end{itemize}
	\vspace{-0.50em}
	...
	\end{itemize}
	\vspace{-0.50em}
	\ressubheading{Center for Complex Networks, SBU Partner}{Tehran, Iran}{Research Assistant}{November 2025 – June 2026}
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Worked on fashion trend forecasting project under supervision of Prof. Reza jafari.}
	\end{itemize}
	\vspace{-0.50em}
	...
	\begin{itemize}[topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
		\resitem{Performed MASW\footnotemark[4] to extract dispersion images under supervision of Prof. Mehdi Talkhablou.}
	\end{itemize}
