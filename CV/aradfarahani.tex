...
\begin{itemize}[topsep=9pt, partopsep=0pt, itemsep=3.5pt, parsep=0pt]
	\resitem{Presented a numerical groundwater modeling study on water abstraction impacts in the Weyib Watershed, Ethiopia. Under Supervision of the Prof. Arnaud Gauthier.}
\end{itemize}
	\vspace{-2em} 
