...
\footnotetext[3]{Civil Aviation Authority of Islamic Republic of Iran}
	...
	\begin{description}[itemsep=0pt]
		...
		Python (ObsPy, pyGIMLi, XGBoost, OpenCV, TensorFlow, NumPy, PyGMT, Xarray, Pandas, Scikit-learn, Matplotlib, Plotly, kepler.gl, Leafmap, Folium, Seaborn, Rasterio, GeoPandas), Julia, Bash (Shell scripting), MySQL; Familiar with R
