...
\end{itemize}
	...
	\begin{justify}
		...
		\begin{enumerate}[label=\arabic*.,left=0pt,topsep=7.5pt,partopsep=0pt,itemsep=3.5pt,parsep=0pt]
			\item \href{}{Talkhablou, M., \textbf{Farmahini Farahani, M.}, \& Mansouri, S. S. (2025). A Python-Based Framework for Land Cover Classification in Engineering Geology: A Comparative Assessment of SVM, K-Means, and Spectral Indices. \textit{\textbf{Kharazmi Journal of Earth Sciences.}}} (In Press)
